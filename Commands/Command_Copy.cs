...
{
    public class Command_Copy : IRocketCommand
    {
        ...
        public List<string> Aliases => new List<string>() { "copykit" };

        public List<string> Permissions => new List<string> { "ck.copy" };

        public const string OTHER_PERM = "ck.copy.other";
        public const string BYPASS_PERM = "ck.copy.bypass";
